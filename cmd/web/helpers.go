 ...
 * convenience wrapper around clientErro which sends a 404 Not Found response to 
 * the user. 
 */
...
func (app *application) render(w http.ResponseWriter, status int, page string, data *templateData) {
     ...
     * provided name, then create a new error and all the serverError() helper 
     ...
     * http.RespondeWrite. If there's an error, call our serverError() helper
     * and then return
     */
